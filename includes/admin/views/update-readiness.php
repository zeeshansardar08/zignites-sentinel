...
$selected_snapshot_status_badges = isset( $view_data['selected_snapshot_status_badges'] ) && is_array( $view_data['selected_snapshot_status_badges'] ) ? $view_data['selected_snapshot_status_badges'] : array();
...
$pre_restore_safety_status = isset( $view_data['pre_restore_safety_status'] ) && is_array( $view_data['pre_restore_safety_status'] ) ? $view_data['pre_restore_safety_status'] : array();
$pre_restore_safety_check_rows = isset( $view_data['pre_restore_safety_check_rows'] ) && is_array( $view_data['pre_restore_safety_check_rows'] ) ? $view_data['pre_restore_safety_check_rows'] : array();
$pre_restore_safety_warnings = isset( $view_data['pre_restore_safety_warnings'] ) && is_array( $view_data['pre_restore_safety_warnings'] ) ? $view_data['pre_restore_safety_warnings'] : array();
$restore_failure_summary = isset( $view_data['restore_failure_summary'] ) && is_array( $view_data['restore_failure_summary'] ) ? $view_data['restore_failure_summary'] : array();
$rollback_confidence_summary = isset( $view_data['rollback_confidence_summary'] ) && is_array( $view_data['rollback_confidence_summary'] ) ? $view_data['rollback_confidence_summary'] : array();
$workspace_primary_action = isset( $view_data['workspace_primary_action'] ) && is_array( $view_data['workspace_primary_action'] ) ? $view_data['workspace_primary_action'] : array();
...
$show_pre_restore_safety = ! empty( $view_visibility['show_pre_restore_safety'] );
$show_pre_restore_safety_checks = ! empty( $view_visibility['show_pre_restore_safety_checks'] );
$show_pre_restore_safety_warnings = ! empty( $view_visibility['show_pre_restore_safety_warnings'] );
...
$show_restore_failure_summary = ! empty( $view_visibility['show_restore_failure_summary'] );
$show_restore_failure_actions = ! empty( $view_visibility['show_restore_failure_actions'] );
$show_rollback_confidence_summary = ! empty( $view_visibility['show_rollback_confidence_summary'] );
$show_rollback_confidence_rows = ! empty( $view_visibility['show_rollback_confidence_rows'] );
...
$show_system_health_rows = ! empty( $view_visibility['show_system_health_rows'] );
$show_snapshot_intelligence_warnings = ! empty( $view_visibility['show_snapshot_intelligence_warnings'] );
$show_recommended_snapshot_card = ! empty( $view_visibility['show_recommended_snapshot_card'] );
$show_last_known_good_card = ! empty( $view_visibility['show_last_known_good_card'] );
$show_operator_timeline_rows = ! empty( $view_visibility['show_operator_timeline_rows'] );
$show_workspace_primary_action = ! empty( $view_visibility['show_workspace_primary_action'] );
...
$system_health_status      = isset( $view_data['system_health_status'] ) && is_array( $view_data['system_health_status'] ) ? $view_data['system_health_status'] : array();
$system_health_rows        = isset( $view_data['system_health_rows'] ) && is_array( $view_data['system_health_rows'] ) ? $view_data['system_health_rows'] : array();
$recommended_snapshot_card = isset( $view_data['recommended_snapshot_card'] ) && is_array( $view_data['recommended_snapshot_card'] ) ? $view_data['recommended_snapshot_card'] : array();
...
<div class="wrap znts-admin-page">
	...
	<section class="znts-summary-hero">
		...
		<div class="znts-readiness-row">
			...
			<?php if ( ! empty( $system_health_status ) ) : ?>
				<span class="znts-pill znts-pill-<?php echo esc_attr( isset( $system_health_status['badge'] ) ? $system_health_status['badge'] : 'info' ); ?>">
					<?php echo esc_html( isset( $system_health_status['title'] ) ? $system_health_status['title'] : __( 'System Health', 'zignites-sentinel' ) ); ?>:
					<?php echo esc_html( isset( $system_health_status['status_label'] ) ? $system_health_status['status_label'] : '' ); ?>
				</span>
			<?php endif; ?>
		...
		<div class="znts-summary-strip">
			<div class="znts-summary-item">
				<span><?php echo esc_html__( 'System health', 'zignites-sentinel' ); ?></span>
				<strong><?php echo esc_html( isset( $system_health_status['status_label'] ) ? $system_health_status['status_label'] : __( 'Unknown', 'zignites-sentinel' ) ); ?></strong>
				<p><?php echo esc_html( isset( $system_health_status['note'] ) ? $system_health_status['note'] : '' ); ?></p>
			</div>
			<div class="znts-summary-item">
				<span><?php echo esc_html__( 'Recommended snapshot', 'zignites-sentinel' ); ?></span>
				<strong><?php echo esc_html( ! empty( $recommended_snapshot_card['label'] ) ? $recommended_snapshot_card['label'] : __( 'Not available', 'zignites-sentinel' ) ); ?></strong>
				<p><?php echo esc_html( ! empty( $recommended_snapshot_card['note'] ) ? $recommended_snapshot_card['note'] : __( 'Sentinel has not found a fully trusted snapshot yet.', 'zignites-sentinel' ) ); ?></p>
			</div>
			<div class="znts-summary-item">
				<span><?php echo esc_html__( 'Last known good', 'zignites-sentinel' ); ?></span>
				<strong><?php echo esc_html( ! empty( $last_known_good_card['label'] ) ? $last_known_good_card['label'] : __( 'Not identified', 'zignites-sentinel' ) ); ?></strong>
				<p><?php echo esc_html( ! empty( $last_known_good_card['note'] ) ? $last_known_good_card['note'] : __( 'No historical good state has been inferred yet.', 'zignites-sentinel' ) ); ?></p>
			</div>
			<div class="znts-summary-item">
		...
		<?php if ( $show_workspace_primary_action ) : ?>
			<div class="znts-hero-recommendation">
				...
				<?php endif; ?>
				<?php if ( ! empty( $workspace_primary_action['href'] ) ) : ?>
					<p><a class="button button-primary" href="<?php echo esc_url( $workspace_primary_action['href'] ); ?>"><?php echo esc_html( isset( $workspace_primary_action['button_label'] ) ? $workspace_primary_action['button_label'] : __( 'Review', 'zignites-sentinel' ) ); ?></a></p>
				<?php endif; ?>
				<?php if ( '' !== $workspace_confidence ) : ?>
					<p class="description"><?php echo esc_html( $workspace_confidence ); ?></p>
				<?php endif; ?>
			</div>
		<?php endif; ?>
			...
			<section class="znts-card znts-card-full znts-card-flat">
				...
				<?php if ( $show_system_health_rows ) : ?>
					<table class="widefat striped">
						<tbody>
							<?php foreach ( $system_health_rows as $row ) : ?>
								<tr>
									<th scope="row"><?php echo esc_html( $row['label'] ); ?></th>
									<td>
										<?php echo esc_html( $row['value'] ); ?>
										<?php if ( ! empty( $row['show_note'] ) ) : ?>
				...
				<?php endif; ?>
				<?php if ( $show_snapshot_intelligence_warnings ) : ?>
					<div class="znts-alert-panel znts-alert-panel-warning">
						<strong><?php echo esc_html__( 'Snapshot Warnings', 'zignites-sentinel' ); ?></strong>
						<ul class="znts-list">
							<?php foreach ( $snapshot_intelligence_warnings as $warning ) : ?>
								<li><?php echo esc_html( $warning ); ?></li>
							<?php endforeach; ?>
						</ul>
					</div>
				<?php endif; ?>
				<?php if ( $show_operator_timeline_rows ) : ?>
					<h3><?php echo esc_html__( 'Operator Timeline', 'zignites-sentinel' ); ?></h3>
					<ul class="znts-timeline-list">
						<?php foreach ( $operator_timeline_rows as $timeline_row ) : ?>
							<li class="znts-timeline-item">
								<div class="znts-timeline-meta">
									<span class="znts-pill znts-pill-<?php echo esc_attr( $timeline_row['badge'] ); ?>">
										<?php echo esc_html( $timeline_row['title'] ); ?>
									</span>
									<span><?php echo esc_html( $timeline_row['timestamp'] ); ?></span>
								</div>
								<p><?php echo esc_html( $timeline_row['message'] ); ?></p>
							</li>
						<?php endforeach; ?>
					</ul>
	...
	<div class="znts-admin-grid znts-readiness-grid">
				...
				<div class="znts-status-grid">
					<?php foreach ( $restore_run_card_rows as $card ) : ?>
						<section class="znts-status-card">
							<div class="znts-readiness-row">
								<span class="znts-pill znts-pill-<?php echo esc_attr( $card['badge'] ); ?>">
									<?php echo esc_html( $card['status_label'] ); ?>
								</span>
								<span><?php echo esc_html( $card['timestamp'] ); ?></span>
							</div>
		...
		<?php if ( $has_form_snapshot ) : ?>
			<section id="znts-pre-restore-checklist" class="znts-card znts-card-full znts-card-secondary">
				<div class="znts-section-header">
					<div>
				...
				<?php else : ?>
					<div class="znts-readiness-row">
						<span class="znts-pill znts-pill-<?php echo esc_attr( $snapshot_health_baseline_status['badge'] ); ?>">
							<?php echo esc_html( $snapshot_health_baseline_status['status_label'] ); ?>
						</span>
						<span><?php echo esc_html( $snapshot_health_baseline_status['generated_at'] ); ?></span>
					</div>
				...
				<?php if ( $show_audit_report_verification ) : ?>
					...
					<div class="znts-readiness-row">
						<span class="znts-pill znts-pill-<?php echo esc_attr( $audit_report_verification_status['badge'] ); ?>">
							<?php echo esc_html( $audit_report_verification_status['status_label'] ); ?>
						</span>
		...
		<section id="znts-snapshot-library" class="znts-card znts-card-secondary">
		...
		<section class="znts-card znts-card-secondary">
			...
			<?php else : ?>
				<div class="znts-readiness-row">
					<span class="znts-pill znts-pill-<?php echo esc_attr( $preflight_status['badge'] ); ?>">
						<?php echo esc_html( $preflight_status['status_label'] ); ?>
					</span>
					<span><?php echo esc_html( $preflight_status['generated_at'] ); ?></span>
				</div>
				<p><?php echo esc_html( $preflight_status['note'] ); ?></p>
				<table class="widefat striped">
					<thead>
						<tr>
							<th><?php echo esc_html__( 'Check', 'zignites-sentinel' ); ?></th>
		...
		<section class="znts-card znts-card-secondary">
			...
			<?php else : ?>
				<div class="znts-readiness-row">
					<span class="znts-pill znts-pill-<?php echo esc_attr( $last_update_plan_status['badge'] ); ?>">
						<?php echo esc_html( $last_update_plan_status['status_label'] ); ?>
					</span>
						...
						<?php foreach ( $recent_snapshot_rows as $snapshot ) : ?>
							<tr>
								...
								<td>
									...
									<?php if ( ! empty( $snapshot['relationship'] ) ) : ?>
										<p class="description"><?php echo esc_html( $snapshot['relationship'] ); ?></p>
									<?php endif; ?>
								</td>
								<td>
									<span class="znts-pill znts-pill-<?php echo esc_attr( $snapshot['trust_badge'] ); ?>">
										<?php echo esc_html( $snapshot['trust_label'] ); ?>
									</span>
								</td>
								<td>
									<div class="znts-badge-row">
			...
			<section class="znts-card znts-card-full znts-card-flat">
				...
				<?php if ( $show_artifact_diff ) : ?>
					<details class="znts-disclosure">
						...
						<div class="znts-disclosure-body">
							<p><?php echo esc_html( $artifact_diff_state['message'] ); ?></p>
							<table class="widefat striped">
								<thead>
									<tr>
										<th><?php echo esc_html__( 'Type', 'zignites-sentinel' ); ?></th>
								...
								<tbody>
									<?php foreach ( $artifact_diff_state['rows'] as $item ) : ?>
										<tr>
		...
		<?php if ( $show_restore_readiness ) : ?>
			<section class="znts-card znts-card-full znts-card-flat">
				...
				<div class="znts-readiness-row">
					<span class="znts-pill znts-pill-<?php echo esc_attr( $restore_readiness_status['badge'] ); ?>">
						<?php echo esc_html( $restore_readiness_status['status_label'] ); ?>
					</span>
					<span><?php echo esc_html( $restore_readiness_status['generated_at'] ); ?></span>
				</div>
				<p><?php echo esc_html( $restore_readiness_status['note'] ); ?></p>
				<table class="widefat striped">
					<thead>
						<tr>
							<th><?php echo esc_html__( 'Check', 'zignites-sentinel' ); ?></th>
		...
		<?php if ( $show_restore_dry_run ) : ?>
			<section id="znts-restore-dry-run" class="znts-card znts-card-full znts-card-flat">
				...
				<div class="znts-readiness-row">
					<span class="znts-pill znts-pill-<?php echo esc_attr( $restore_dry_run_status['badge'] ); ?>">
						<?php echo esc_html( $restore_dry_run_status['status_label'] ); ?>
					</span>
					<span><?php echo esc_html( $restore_dry_run_status['generated_at'] ); ?></span>
				</div>
				<p><?php echo esc_html( $restore_dry_run_status['note'] ); ?></p>
				<table class="widefat striped">
					<thead>
						<tr>
							<th><?php echo esc_html__( 'Check', 'zignites-sentinel' ); ?></th>
		...
		<?php if ( $show_restore_stage ) : ?>
			<section id="znts-restore-stage" class="znts-card znts-card-full znts-card-flat">
				...
				<div class="znts-readiness-row">
					<span class="znts-pill znts-pill-<?php echo esc_attr( $restore_stage_status['badge'] ); ?>">
						<?php echo esc_html( $restore_stage_status['status_label'] ); ?>
					</span>
					<span><?php echo esc_html( $restore_stage_status['generated_at'] ); ?></span>
				</div>
				<p><?php echo esc_html( $restore_stage_status['note'] ); ?></p>
				<table class="widefat striped">
					<thead>
						<tr>
							<th><?php echo esc_html__( 'Check', 'zignites-sentinel' ); ?></th>
		...
		<?php if ( $show_restore_plan ) : ?>
			<section id="znts-restore-plan" class="znts-card znts-card-full znts-card-flat">
				...
				<div class="znts-readiness-row">
					<span class="znts-pill znts-pill-<?php echo esc_attr( $restore_plan_status['badge'] ); ?>">
						<?php echo esc_html( $restore_plan_status['status_label'] ); ?>
					</span>
				...
				<?php if ( $show_restore_impact_summary ) : ?>
					...
					<div class="znts-readiness-row">
						<span class="znts-pill znts-pill-<?php echo esc_attr( $restore_impact_summary['status'] ); ?>">
							<?php echo esc_html( $restore_impact_summary['title'] ); ?>
						</span>
					</div>
					...
					<?php endif; ?>
				<?php endif; ?>
				<?php if ( $show_pre_restore_safety ) : ?>
					<h3><?php echo esc_html__( 'Pre-Restore Checklist', 'zignites-sentinel' ); ?></h3>
					<div class="znts-alert-panel znts-alert-panel-<?php echo esc_attr( isset( $pre_restore_safety_status['badge'] ) ? $pre_restore_safety_status['badge'] : 'info' ); ?>">
						<strong><?php echo esc_html( isset( $pre_restore_safety_status['title'] ) ? $pre_restore_safety_status['title'] : __( 'Pre-Restore Checklist', 'zignites-sentinel' ) ); ?></strong>
						<p><?php echo esc_html( isset( $pre_restore_safety_status['note'] ) ? $pre_restore_safety_status['note'] : '' ); ?></p>
					</div>
					<?php if ( $show_pre_restore_safety_checks ) : ?>
						<table class="widefat striped">
							<thead>
								<tr>
									<th><?php echo esc_html__( 'Requirement', 'zignites-sentinel' ); ?></th>
							...
							<tbody>
								<?php foreach ( $pre_restore_safety_check_rows as $check ) : ?>
									<tr>
										<td><?php echo esc_html( $check['label'] ); ?></td>
										<td>
											<span class="znts-pill znts-pill-<?php echo esc_attr( $check['badge'] ); ?>">
					...
					<?php endif; ?>
					<?php if ( $show_pre_restore_safety_warnings ) : ?>
						<h4><?php echo esc_html__( 'Actionable warnings', 'zignites-sentinel' ); ?></h4>
						<ul class="znts-list">
							<?php foreach ( $pre_restore_safety_warnings as $warning ) : ?>
								<li><?php echo esc_html( $warning ); ?></li>
							<?php endforeach; ?>
						</ul>
					<?php endif; ?>
				...
				<?php else : ?>
					<p class="description"><?php echo esc_html( ! empty( $restore_form_state['pre_restore_block_message'] ) ? $restore_form_state['pre_restore_block_message'] : __( 'Live restore remains hidden until the pre-restore checklist is complete for this snapshot.', 'zignites-sentinel' ) ); ?></p>
				<?php endif; ?>
		...
		<?php if ( $show_restore_execution ) : ?>
			<section id="znts-restore-execution-result" class="znts-card znts-card-full znts-card-flat">
				<h2><?php echo esc_html__( 'Restore Execution Result', 'zignites-sentinel' ); ?></h2>
				<div class="znts-readiness-row">
					<span class="znts-pill znts-pill-<?php echo esc_attr( $restore_execution_status['badge'] ); ?>">
						<?php echo esc_html( $restore_execution_status['status_label'] ); ?>
					</span>
					<span><?php echo esc_html( $restore_execution_status['generated_at'] ); ?></span>
				</div>
				<p><?php echo esc_html( $restore_execution_status['note'] ); ?></p>
				<?php if ( $show_restore_failure_summary ) : ?>
					<div class="znts-alert-panel znts-alert-panel-<?php echo esc_attr( isset( $restore_failure_summary['badge'] ) ? $restore_failure_summary['badge'] : 'warning' ); ?>">
						<strong><?php echo esc_html( isset( $restore_failure_summary['title'] ) ? $restore_failure_summary['title'] : '' ); ?></strong>
						<p><?php echo esc_html( isset( $restore_failure_summary['message'] ) ? $restore_failure_summary['message'] : '' ); ?></p>
					</div>
					<table class="widefat striped">
						<tbody>
							<?php foreach ( isset( $restore_failure_summary['rows'] ) && is_array( $restore_failure_summary['rows'] ) ? $restore_failure_summary['rows'] : array() as $row ) : ?>
								<tr>
									<th scope="row"><?php echo esc_html( $row['label'] ); ?></th>
									<td><?php echo esc_html( $row['value'] ); ?></td>
								</tr>
					...
					<?php if ( $show_restore_failure_actions ) : ?>
						<h3><?php echo esc_html__( 'Recommended Recovery Actions', 'zignites-sentinel' ); ?></h3>
						<ul class="znts-list">
							<?php foreach ( $restore_failure_summary['actions'] as $action ) : ?>
								<li>
									<a href="<?php echo esc_url( $action['href'] ); ?>"><?php echo esc_html( $action['label'] ); ?></a>
									<?php if ( ! empty( $action['description'] ) ) : ?>
										<span class="znts-inline-note"><?php echo esc_html( ' ' . $action['description'] ); ?></span>
									<?php endif; ?>
								</li>
							<?php endforeach; ?>
						</ul>
				...
				<?php if ( $show_execution_health_section ) : ?>
					...
					<div class="znts-readiness-row">
						<span class="znts-pill znts-pill-<?php echo esc_attr( $restore_execution_health_status['badge'] ); ?>">
							<?php echo esc_html( $restore_execution_health_status['status_label'] ); ?>
						</span>
						<span><?php echo esc_html( $restore_execution_health_status['generated_at'] ); ?></span>
					</div>
					<p><?php echo esc_html( $restore_execution_health_status['note'] ); ?></p>
					<table class="widefat striped">
						<thead>
							<tr>
								<th><?php echo esc_html__( 'Check', 'zignites-sentinel' ); ?></th>
				...
				<?php if ( $show_execution_rollback_form ) : ?>
					<h3 id="znts-rollback-confidence"><?php echo esc_html__( 'Rollback From Backup', 'zignites-sentinel' ); ?></h3>
					...
					<?php if ( $show_rollback_confidence_summary ) : ?>
						<div class="znts-alert-panel znts-alert-panel-<?php echo esc_attr( isset( $rollback_confidence_summary['badge'] ) ? $rollback_confidence_summary['badge'] : 'info' ); ?>">
							<strong><?php echo esc_html( isset( $rollback_confidence_summary['title'] ) ? $rollback_confidence_summary['title'] : '' ); ?></strong>
							<p><?php echo esc_html( isset( $rollback_confidence_summary['message'] ) ? $rollback_confidence_summary['message'] : '' ); ?></p>
						</div>
						<?php if ( $show_rollback_confidence_rows ) : ?>
							<table class="widefat striped">
								<tbody>
									<?php foreach ( $rollback_confidence_summary['rows'] as $row ) : ?>
										<tr>
											<th scope="row"><?php echo esc_html( $row['label'] ); ?></th>
											<td><?php echo esc_html( $row['value'] ); ?></td>
										</tr>
		...
		<?php if ( $show_restore_rollback ) : ?>
			<section class="znts-card znts-card-full znts-card-flat">
				...
				<div class="znts-readiness-row">
					<span class="znts-pill znts-pill-<?php echo esc_attr( $restore_rollback_status['badge'] ); ?>">
						<?php echo esc_html( $restore_rollback_status['status_label'] ); ?>
					</span>
				...
				<?php if ( $show_rollback_health_section ) : ?>
					...
					<div class="znts-readiness-row">
						<span class="znts-pill znts-pill-<?php echo esc_attr( $restore_rollback_health_status['badge'] ); ?>">
							<?php echo esc_html( $restore_rollback_health_status['status_label'] ); ?>
						</span>
						<span><?php echo esc_html( $restore_rollback_health_status['generated_at'] ); ?></span>
					</div>
