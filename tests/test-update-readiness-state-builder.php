...
function znts_test_update_readiness_state_builder_normalizes_screen_state() {
	...
	znts_assert_same( true, $state['view_visibility']['show_audit_report_verification'], 'Update Readiness state builder should expose audit verification visibility.' );
	...
	znts_assert_same( true, $state['view_visibility']['show_selected_snapshot_badges'], 'Update Readiness state builder should expose selected snapshot badge visibility.' );
	znts_assert_same( true, $state['view_visibility']['show_snapshot_summary_status_badges'], 'Update Readiness state builder should expose snapshot summary badge visibility.' );
	znts_assert_same( true, $state['view_visibility']['has_snapshot_summary_risks'], 'Update Readiness state builder should expose snapshot summary risk visibility.' );
	znts_assert_same( true, $state['view_visibility']['show_snapshot_activity_history_link'], 'Update Readiness state builder should expose snapshot activity history-link visibility.' );
	...
	znts_assert_same( true, $state['view_visibility']['show_restore_action_jump_links'], 'Update Readiness state builder should expose restore action jump-link visibility.' );
	znts_assert_same( true, $state['view_visibility']['show_snapshot_metadata'], 'Update Readiness state builder should expose snapshot metadata visibility.' );
	znts_assert_same( true, $state['view_visibility']['show_component_manifest'], 'Update Readiness state builder should expose component manifest visibility.' );
	znts_assert_same( true, $state['view_visibility']['show_snapshot_artifacts'], 'Update Readiness state builder should expose snapshot artifact visibility.' );
	znts_assert_same( true, $state['view_visibility']['show_artifact_diff'], 'Update Readiness state builder should expose artifact diff visibility.' );
	znts_assert_same( true, $state['view_visibility']['show_active_plugin_rows'], 'Update Readiness state builder should expose active plugin visibility.' );
	znts_assert_same( true, $state['view_visibility']['has_missing_snapshot_plugins'], 'Update Readiness state builder should expose missing snapshot plugin visibility.' );
	znts_assert_same( true, $state['view_visibility']['has_new_current_plugins'], 'Update Readiness state builder should expose new current plugin visibility.' );
	znts_assert_same( true, $state['view_visibility']['has_plugin_version_changes'], 'Update Readiness state builder should expose plugin version-change visibility.' );
	...
	znts_assert_same( true, $state['view_visibility']['show_execution_checkpoint_summary'], 'Update Readiness state builder should expose execution checkpoint summary visibility.' );
	znts_assert_same( true, $state['view_visibility']['show_rollback_checkpoint_summary'], 'Update Readiness state builder should expose rollback checkpoint summary visibility.' );
	znts_assert_same( true, $state['view_visibility']['show_snapshot_health_comparison'], 'Update Readiness state builder should expose health comparison visibility.' );
	znts_assert_same( true, $state['view_visibility']['show_operator_checklist_checks'], 'Update Readiness state builder should expose operator checklist table visibility.' );
	znts_assert_same( true, $state['view_visibility']['show_audit_report_verification_checks'], 'Update Readiness state builder should expose audit verification table visibility.' );
	znts_assert_same( true, $state['view_visibility']['show_update_candidate_rows'], 'Update Readiness state builder should expose update candidate table visibility.' );
	...
	znts_assert_same( true, $state['view_visibility']['show_execution_checks'], 'Update Readiness state builder should expose execution check visibility.' );
	...
	znts_assert_same( true, $state['view_visibility']['show_rollback_items'], 'Update Readiness state builder should expose rollback item visibility.' );
	znts_assert_same( true, $state['view_visibility']['show_rollback_journal'], 'Update Readiness state builder should expose rollback journal visibility.' );
