...
require_once __DIR__ . '/test-operation-lock.php';
require_once __DIR__ . '/test-disk-space-preflight.php';
...
require_once __DIR__ . '/test-artifact-exposure-scanner.php';
...
require_once __DIR__ . '/test-alert-integrations.php';
require_once __DIR__ . '/test-woocommerce-guardrails.php';
...
require_once __DIR__ . '/test-incident-summary-model.php';
